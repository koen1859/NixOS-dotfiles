...
static const char *protonpasscmd[] = {"proton-pass", NULL};
static const char *protonmailcmd[] = {"proton-mail", NULL};
...
static const char *bookcmd[] = {
    "sh", "-c", "ls",      "~/Documents/Books",   "|", "dmenu", "|", "xargs",
    "-I", "{}", "zathura", "~/Documents/Books/{}"};
